class Form {
    ...
    display(){
      ...
      this.input.position(displayWidth/2-100, displayHeight/2-300);
      this.input1.position(displayWidth/2-100, displayHeight/2-250);
      this.input2.position(displayWidth/2-100, displayHeight/2-200);
      this.input3.position(displayWidth/2-100, displayHeight/2-150);
      this.input4.position(displayWidth/2-100, displayHeight/2-100);
      this.input5.position(displayWidth/2-100, displayHeight/2-50);
      this.input6.position(displayWidth/2-100, displayHeight/2);
      this.input7.position(displayWidth/2-100, displayHeight/2+50);
      this.input8.position(displayWidth/2-100, displayHeight/2+100);
      this.input9.position(displayWidth/2-100, displayHeight/2+150);
